...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_nodata = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_nodata.setObjectName("checkBox_nodata")
        self.horizontalLayout.addWidget(self.checkBox_nodata)
        self.checkBox_selorall = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_selorall.setObjectName("checkBox_selorall")
        self.horizontalLayout.addWidget(self.checkBox_selorall)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_nodata.setText(_translate("MainWindow", "只抄没有数据的表"))
        self.checkBox_selorall.setText(_translate("MainWindow", "只抄当前选中的表"))
